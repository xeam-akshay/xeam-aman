...
back(){
  ...
  context.props.navigation.navigate("LeaveSection");
    ...
    render (){
          const {leaves,message,msg,date,name,id,leave_type,from_date,to_date,from_time,to_time,leave_replacement,leave_reason,can_cancel_leave,applied_leave_id,data_two,handOverTask}= this.state;
      ...
      <View style={{flexDirection:'row',justifyContent:'center',top:hp('3%')}}>
      ...
      <Image source={LeftSide} style={{left:wp('31%'),bottom:'41.1%',height:'4.9%',width:50,borderColor:'black',alignItems:'center'}}/>
